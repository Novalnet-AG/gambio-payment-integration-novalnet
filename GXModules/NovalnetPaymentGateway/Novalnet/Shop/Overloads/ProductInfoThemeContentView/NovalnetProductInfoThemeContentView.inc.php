 ...
 *
 * This script is used to display the wallet payment option on the product page.
 *
 * @author    Novalnet AG
 ...
 *
 * Script : NovalnetCheckoutSuccessThemeContentView.inc.php
 */

class NovalnetProductInfoThemeContentView extends NovalnetProductInfoThemeContentView_parent
{
    public function prepare_data()
    {
        ...
        if ($applepay->enabled == true && strpos($display_page, 'product page') !== false && $helper->checkApplePayIsAvailable()) {
            $walletParams = $validator->getWalletParams('novalnet_applepay', 'product_detail');
            $applepay_visibility_amount = constant('MODULE_PAYMENT_' . strtoupper('novalnet_applepay') . '_VISIBILITY_BY_AMOUNT');
            $this->set_content_data('NOVALNET_APPLEPAY_VISIBILITY_BY_AMOUNT', $applepay_visibility_amount);
            $this->set_content_data('NOVALNET_APPLEPAY_AVAILABLE', true);
        ...
        if ($googlepay->enabled == true && strpos($display_page, 'product page') !== false) {
            $walletParams = $validator->getWalletParams('novalnet_googlepay', 'product_detail');
            $googlepay_visibility_amount = constant('MODULE_PAYMENT_' . strtoupper('novalnet_googlepay') . '_VISIBILITY_BY_AMOUNT');
            $this->set_content_data('NOVALNET_GOOGLEPAY_VISIBILITY_BY_AMOUNT', $googlepay_visibility_amount);
            $this->set_content_data('NOVALNET_GOOGLEPAY_AVAILABLE', true);
