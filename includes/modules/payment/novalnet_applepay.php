...
class novalnet_applepay {
	...
	function before_process() {
		...
		if ((defined('MODULE_PAYMENT_NOVALNET_APPLEPAY_AUTHENTICATE') && MODULE_PAYMENT_NOVALNET_APPLEPAY_AUTHENTICATE == 'true') && (NovalnetHelper::getOrderAmount($order->info['total']) >= (defined('MODULE_PAYMENT_NOVALNET_APPLEPAY_MANUAL_CHECK_LIMIT') ? MODULE_PAYMENT_NOVALNET_APPLEPAY_MANUAL_CHECK_LIMIT : ''))) { // for on-hold transaction
