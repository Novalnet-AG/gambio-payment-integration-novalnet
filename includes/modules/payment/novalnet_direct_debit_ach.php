...
class novalnet_direct_debit_ach {
	...
	function __construct() {
		...
		$this->description= ((defined('MODULE_PAYMENT_NOVALNET_DIRECT_DEBIT_ACH_TEXT_TITLE')) ? MODULE_PAYMENT_NOVALNET_DIRECT_DEBIT_ACH_TEXT_TITLE : '');
		...
		function selection() {
		   ...
		   if (defined('MODULE_PAYMENT_NOVALNET_DIRECT_DEBIT_ACH_TOKENIZATION') && MODULE_PAYMENT_NOVALNET_DIRECT_DEBIT_ACH_TOKENIZATION == 'true') {
			...
			$selection['fields'][] = [
			   ...
			   $selection['fields'][] = [
				   'title' =>'<div class="novalnet-group">'. '<nobr><div id="ach_save_card">'.xtc_draw_checkbox_field('nn_ach_checkbox', 1 , false, 'id="novalnet_direct_debit_ach_onclick"')." ".MODULE_PAYMENT_NOVALNET_SEPA_SAVE_CARD_DETAILS.'</div></nobr>'.'</div>',
			   ];
		   } else {
				$selection['fields'][] = [
					'title' =>'<div class="novalnet-group" >'. MODULE_PAYMENT_NOVALNET_DIRECT_DEBIT_ACH_ACCOUNT_HOLDER.'<br>'. xtc_draw_input_field('novalnet_ach_account_holder', $order->customer['firstname'] . ' ' . $order->customer['lastname'], 'id="novalnet_ach_account_holder" autocomplete="off" placeholder ="'.MODULE_PAYMENT_NOVALNET_DIRECT_DEBIT_ACH_ACCOUNT_HOLDER.'" style="width:170%;"').'</div>',
	...
	function pre_confirmation_check() {
		$_SESSION['novalnet_direct_debit_ach'] = isset($_REQUEST['novalnet_direct_debit_ach']) ? $_REQUEST['novalnet_direct_debit_ach'] : '';
