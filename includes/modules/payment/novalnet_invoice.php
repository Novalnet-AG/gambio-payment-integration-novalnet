...
class novalnet_invoice {
    ...
    function selection() {
			...
			if (!empty($_SESSION['novalnet'][$this->code]['guarantee']) && (($order->billing['company'] == '') || ($order->billing['company'] != '' && MODULE_PAYMENT_NOVALNET_INVOICE_ALLOW_B2B == 'false'))) {
				$selection['fields'][] = array(
							...
							'field' => '<div>'.xtc_draw_hidden_field('', MODULE_PAYMENT_NOVALNET_BIRTH_DATE , 'id="nn_dob_placeholder"').xtc_draw_input_field($this->code.'_dob',$customer_dbvalue['customers_dob'], 'id="'.$this->code.'_dob" AUTOCOMPLETE=off class=form-control form-type-date hasDatepicker').xtc_draw_hidden_field('', $_SESSION['language_code'], 'id="nn_shop_lang"').'</div>
    ...
    function before_process() {
        ...
        $param_inputs              = array_merge((array) $order, $_SESSION['novalnet'][$this->code]);
            //  payment request send to the novalnet server
    ...
    function install() {
		if($_SESSION['GX'] == '1'){
			...
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_ALLOWED', '',  '1',  now())");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_ALIAS', 'NN_INV', '0',  now())");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_STATUS','false',  '2', 'switcher',now())");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_TEST_MODE','false',  '3', 'switcher', now())");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_AUTHENTICATE','false', '4' ,'switcher', now())");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,  `sort_order`,  `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_MANUAL_CHECK_LIMIT', '',  '7',  now())");
			...
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_ALLOW_B2B','true',  '4' ,'switcher', now())");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_VISIBILITY_BY_AMOUNT', '',  '7',now()) ");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_ENDCUSTOMER_INFO', '', '8', now()) ");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_SORT_ORDER', '0', '9',  now()) ");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_ORDER_STATUS', '0',  '10', 'order-status', now()) ");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_CALLBACK_ORDER_STATUS', '0', '11', 'order-status', now()) ");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_PAYMENT_ZONE', '0',  '12', 'geo-zone',now())");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_GUARANTEE','false',  '18', 'switcher', now()) ");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_GUARANTEE_MINIMUM_ORDER_AMOUNT', '999',  '18',now()) ");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_PENDING_ORDER_STATUS', '0', '19', 'order-status', now()) ");
			xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_INVOICE_FORCE','true', '20', 'switcher', now())");
      ...
      VALUES ('MODULE_PAYMENT_NOVALNET_INVOICE_ALLOWED', '', '6', '1', '', '', now()),
        ...
        ('MODULE_PAYMENT_NOVALNET_INVOICE_GUARANTEE_MINIMUM_ORDER_AMOUNT', '999', '6', '18','',  '', now()),
