...
class novalnet_invoice {
	...
	function selection() {
		...
		if (MODULE_PAYMENT_NOVALNET_GUARANTEE_INVOICE_STATUS == 'true') {
			...
			} elseif (MODULE_PAYMENT_NOVALNET_GUARANTEE_INVOICE_FORCE == 'true') {
	...
	function before_process(){
		...
		if (MODULE_PAYMENT_NOVALNET_INVOICE_AUTHENTICATE == 'true'
		&& (NovalnetHelper::getOrderAmount($order->info['total']) >= MODULE_PAYMENT_NOVALNET_INVOICE_MANUAL_CHECK_LIMIT)) { // Authorize transaction
