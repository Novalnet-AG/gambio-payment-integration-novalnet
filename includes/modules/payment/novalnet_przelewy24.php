...
class novalnet_przelewy24 {
    ...
    public function __construct() {
        ...
        if (strpos(MODULE_PAYMENT_INSTALLED, $this->code) !== false) {
            ...
            $this->enabled         = ((defined('MODULE_PAYMENT_NOVALNET_PRZELEWY24_ENABLE_MODULE') && MODULE_PAYMENT_NOVALNET_PRZELEWY24_ENABLE_MODULE == 'True') ? true : false);
    ...
    function install() {
        ...
        ('MODULE_PAYMENT_NOVALNET_PRZELEWY24_ENABLE_MODULE','False', '6', '2', 'xtc_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE),\'MODULE_PAYMENT_NOVALNET_PRZELEWY24_ENABLE_MODULE\'," .'MODULE_PAYMENT_NOVALNET_PRZELEWY24_ENABLE_MODULE'. ",' , '',now()),
        ...
        ('MODULE_PAYMENT_NOVALNET_PRZELEWY24_TRANS_REFERENCE1', '', '6', '9', '',  '', now()),
        ('MODULE_PAYMENT_NOVALNET_PRZELEWY24_TRANS_REFERENCE2', '', '6', '10', '',  '', now())");
    }
    ...
    function keys() {
       global $gx_version; // Get the gambio version
	    ...
	    $return_key = array_merge(array(
            ...
            'MODULE_PAYMENT_NOVALNET_PRZELEWY24_ENABLE_MODULE',
            ...
            'MODULE_PAYMENT_NOVALNET_PRZELEWY24_TRANS_REFERENCE1',
            'MODULE_PAYMENT_NOVALNET_PRZELEWY24_TRANS_REFERENCE2'
        ),$alias_menu);
        foreach ($return_key as $key => $value) {
            if( ($gx_version >= '3.1.1.0' && $value == 'MODULE_PAYMENT_NOVALNET_PRZELEWY24_ALIAS')) {
