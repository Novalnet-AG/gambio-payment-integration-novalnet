...
class novalnet_przelewy24 {
    ...
    public function __construct() {
        ...
        $this->title        = 'Novalnet '. MODULE_PAYMENT_NOVALNET_PRZELEWY24_TEXT_TITLE;
        ...
        if (strpos(MODULE_PAYMENT_INSTALLED, $this->code) !== false) {
            ...
            $this->enabled         = (MODULE_PAYMENT_NOVALNET_PRZELEWY24_ENABLE_MODULE == 'True');
            $this->test_mode       = (MODULE_PAYMENT_NOVALNET_PRZELEWY24_TEST_MODE == 'True'); // To check test mode in shop
            $this->tmpOrders       = true;
