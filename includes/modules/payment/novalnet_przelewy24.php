...
class novalnet_przelewy24 {
    ...
    function selection() {
		...
		$selection  = array(
               'id'		  => $this->code,
               'module' 	  => $title,
               'description' => MODULE_PAYMENT_NOVALNET_REDIRECT_DESC . '<br>' . $test_mode . '<br><span id ="notification_buyer_wrap">' . $endcustomerinfo.'</span>');			
		if($shop_version > '3810') {
    ...
    function install() {
		...
		('configuration/MODULE_PAYMENT_NOVALNET_PRZELEWY24_ALLOWED', '', '6', '1', '',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PRZELEWY24_ALIAS', 'NN_PRZ', '6', '0', '',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PRZELEWY24_STATUS','false', '6', '2', 'switcher',now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PRZELEWY24_TEST_MODE','false', '6', '3', 'switcher',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PRZELEWY24_VISIBILITY_BY_AMOUNT', '', '6', '4','',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PRZELEWY24_ENDCUSTOMER_INFO', '', '6', '5','',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PRZELEWY24_SORT_ORDER', '0', '6', '6', '',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PRZELEWY24_PENDING_ORDER_STATUS', '0',  '6', '7', 'order-status' , now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PRZELEWY24_ORDER_STATUS', '0',  '6', '7', 'order-status', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PRZELEWY24_PAYMENT_ZONE', '0', '6', '8', 'geo-zone',now())
		 ");
	 }else{
