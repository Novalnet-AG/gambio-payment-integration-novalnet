...
class novalnet_instantbank {
    ...
    function install() {
		...
		('configuration/MODULE_PAYMENT_NOVALNET_INSTANTBANK_ALLOWED', '', '6', '1', '', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_INSTANTBANK_ALIAS', 'NN_IB', '6', '0', '',now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_INSTANTBANK_STATUS','false', '6', '2', 'switcher',now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_INSTANTBANK_TEST_MODE','false', '6', '3','switcher', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_INSTANTBANK_VISIBILITY_BY_AMOUNT', '', '6', '4','', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_INSTANTBANK_ENDCUSTOMER_INFO', '', '6', '5','', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_INSTANTBANK_SORT_ORDER', '0', '6', '6', '', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_INSTANTBANK_ORDER_STATUS', '0',  '6', '7', 'order-status',now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_INSTANTBANK_PAYMENT_ZONE', '0', '6', '8', 'geo-zone',now())
		 ");
	 }else{
