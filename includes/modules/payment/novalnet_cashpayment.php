...
class novalnet_cashpayment {
    ...
    public function __construct() {
        ...
        $this->title        = 'Novalnet '. MODULE_PAYMENT_NOVALNET_CASHPAYMENT_TEXT_TITLE;
        ...
        if (strpos(MODULE_PAYMENT_INSTALLED, $this->code) !== false) {
            ...
            $this->enabled   = (MODULE_PAYMENT_NOVALNET_CASHPAYMENT_ENABLE_MODULE == 'True');
            $this->test_mode = (MODULE_PAYMENT_NOVALNET_CASHPAYMENT_TEST_MODE == 'True'); // To check the test mode
    ...
    function before_process() {
        ...
        if (trim(MODULE_PAYMENT_NOVALNET_CASHPAYMENT_DUE_DATE) != '' && ctype_digit(trim(MODULE_PAYMENT_NOVALNET_CASHPAYMENT_DUE_DATE))) {
