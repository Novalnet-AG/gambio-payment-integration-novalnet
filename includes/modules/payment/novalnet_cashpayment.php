...
class novalnet_cashpayment
{
	...
	function __construct()
	{
		...
		$this->sort_order 	= defined('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_SORT_ORDER') && MODULE_PAYMENT_NOVALNET_CASHPAYMENT_SORT_ORDER != ''? trim(MODULE_PAYMENT_NOVALNET_CASHPAYMENT_SORT_ORDER) : 0;
	...
	function install() {
		...
		xtc_db_query("insert into `gx_configurations` (`key`, `value`, `sort_order`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_CASHPAYMENT_SORT_ORDER', '8', '9', now()) ");
