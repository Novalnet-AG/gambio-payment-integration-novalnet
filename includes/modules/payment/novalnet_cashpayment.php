...
class novalnet_cashpayment {
    ...
    function install() {
		...
		('configuration/MODULE_PAYMENT_NOVALNET_CASHPAYMENT_ALLOWED', '', '6', '1', '', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_CASHPAYMENT_ALIAS', 'NN_BARZ', '6', '0', '', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_CASHPAYMENT_STATUS','false', '6', '2',  'switcher',now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_CASHPAYMENT_TEST_MODE','false', '6', '3', 'switcher', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_CASHPAYMENT_DUE_DATE', '', '6', '6','',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_CASHPAYMENT_VISIBILITY_BY_AMOUNT', '', '6', '4','',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_CASHPAYMENT_ENDCUSTOMER_INFO', '', '6', '5','',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_CASHPAYMENT_SORT_ORDER', '0', '6', '6', '',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_CASHPAYMENT_ORDER_STATUS', '0',  '6', '7', 'order-status', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_CASHPAYMENT_CALLBACK_ORDER_STATUS', '0',  '6', '8', 'order-status', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_CASHPAYMENT_PAYMENT_ZONE', '0', '6', '9', 'geo-zone',now())
		 ");
	 }else{
