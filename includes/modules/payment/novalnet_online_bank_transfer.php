...
class novalnet_online_bank_transfer {
	...
	function __construct() {
		global $order;
		$this->code         	= 'novalnet_online_bank_transfer';
		...
		$this->description      = ((defined('MODULE_PAYMENT_NOVALNET_ONLINE_BANK_TRANSFER_TEXT_TITLE')) ? MODULE_PAYMENT_NOVALNET_ONLINE_BANK_TRANSFER_TEXT_TITLE : '');
		...
		$this->sort_order   	= defined('MODULE_PAYMENT_NOVALNET_ONLINE_BANK_TRANSFER_SORT_ORDER') && MODULE_PAYMENT_NOVALNET_ONLINE_BANK_TRANSFER_SORT_ORDER != '' ? trim(MODULE_PAYMENT_NOVALNET_ONLINE_BANK_TRANSFER_SORT_ORDER) : 0;
	...
	function install() {
		...
		xtc_db_query("insert into `gx_configurations` (`key`, `value`, `sort_order`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_ONLINE_BANK_TRANSFER_SORT_ORDER', '15', '7', now()) ");
