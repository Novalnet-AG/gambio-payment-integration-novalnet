...
class novalnet_cc {
    ...
    function novalnet_cc() {
        ...
        if (strpos(MODULE_PAYMENT_INSTALLED, $this->code) !== false) { // Allow if payment enable only
			$this->enabled   = ((defined('MODULE_PAYMENT_NOVALNET_CC_ENABLE_MODULE') && MODULE_PAYMENT_NOVALNET_CC_ENABLE_MODULE == 'True') ? true : false);
			if (((defined('MODULE_PAYMENT_NOVALNET_CC_3D_SECURE') && MODULE_PAYMENT_NOVALNET_CC_3D_SECURE == 'True') || (defined('MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE') &&MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE =='True' )) && (empty($post['novalnet_ccchange_account']))) {
				$this->tmpOrders       = true;
    ...
    function selection()     {
        ...
        $this->description = (MODULE_PAYMENT_NOVALNET_CC_3D_SECURE == 'True' || MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE == 'True') ? MODULE_PAYMENT_NOVALNET_CC_REDIRECTION_TEXT_DESCRIPTION :  MODULE_PAYMENT_NOVALNET_CC_TEXT_DESCRIPTION;
		global $gx_version;
		...
		if($shop_version > '3810') {
			if((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True'){
				if(((!defined('MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT == 'True') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT == 'True') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT == 'True')){
						$selection['logo_url'] .= xtc_href_link('images/icons/payment/novalnet_visa_master_amex_maestro_cartasi.png', '', 'SSL', false, false, false, true, true);
				}else if(((!defined('MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT == 'True') &&  ((!defined('MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT == 'False') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT == 'False')){
						$selection['logo_url'] .= xtc_href_link('images/icons/payment/novalnet_visa_master_amex.png', '', 'SSL', false, false, false, true, true);
				}else if(((!defined('MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT == 'True') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT == 'False') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT == 'False')){
						$selection['logo_url'] .= xtc_href_link('images/icons/payment/novalnet_visa_master_cartasi.png', '', 'SSL', false, false, false, true, true);
				}else if(((!defined('MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT == 'True') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT == 'False') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT == 'False')){
						$selection['logo_url'] .= xtc_href_link('images/icons/payment/novalnet_visa_master_maestro.png', '', 'SSL', false, false, false, true, true);
				}else if(((!defined('MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT == 'True') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT == 'True') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT == 'False')){
				...
				}else if(((!defined('MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT == 'False') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT == 'True') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT == 'True')){
						$selection['logo_url'] .= xtc_href_link('images/icons/payment/novalnet_visa_master_amex_cartasi.png', '', 'SSL', false, false, false, true, true);
				}else if(((!defined('MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT == 'True') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT == 'False') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT == 'True')){
						$selection['logo_url'] .= xtc_href_link('images/icons/payment/novalnet_visa_master_maestro_cartasi.png', '', 'SSL', false, false, false, true, true);
				} else if(((!defined('MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT == 'False') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT == 'False') && ((!defined('MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT')) || MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT == 'False')){
		...
		if ( MODULE_PAYMENT_NOVALNET_CC_SHOP_TYPE != 'ONECLICK' || (MODULE_PAYMENT_NOVALNET_CC_SHOP_TYPE == 'ONECLICK' && empty($payment_details) || (MODULE_PAYMENT_NOVALNET_CC_3D_SECURE == 'True' || MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE == 'True'))) { // Displaying iframe form type
            ...
            $selection['fields'][] = array( 'title' => '<div class= nn_cc_ref_details>'. MODULE_PAYMENT_NOVALNET_CC_FORM_CARD_VALID_DATE.'</div>',
												'field' => '<div class= nn_cc_ref_details>'. $payment_details['cc_exp_month'] . ' / ' . $payment_details['cc_exp_year'] . '</div>'.xtc_draw_hidden_field('', DIR_WS_CATALOG, 'id="nn_root_cc_catalog"').'<script src="' . DIR_WS_CATALOG . 'ext/novalnet/js/novalnet_cc.js' . '" type="text/javascript"></script>',
            );
    ...
    function pre_confirmation_check() {
        ...
        $_SESSION['novalnet'][$this->code]['novalnet_ccchange_account'] = (MODULE_PAYMENT_NOVALNET_CC_SHOP_TYPE == 'ONECLICK' && MODULE_PAYMENT_NOVALNET_CC_3D_SECURE == 'False' && MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE =='False'  ) ? $post['novalnet_ccchange_account'] : '0';
        ...
        if (isset($post['nn_payment_ref_tid'])) {
			...
			if ((MODULE_PAYMENT_NOVALNET_CC_3D_SECURE == 'True' || MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE == 'True') || $post['novalnet_ccchange_account'] == 0) {
    ...
    function before_process() {
        ...
        if (isset($post['tid'])) {
        ...
        } else if (!isset($post['tid']) && $_SESSION['novalnet'][$this->code]['novalnet_ccchange_account'] != '1' && (MODULE_PAYMENT_NOVALNET_CC_3D_SECURE != 'True' && MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE != 'True') && empty($_SESSION['novalnet'][$this->code]['nn_payment_ref_tid'])) { // To process credit card iframe with curl call request
            ...
            if (trim(MODULE_PAYMENT_NOVALNET_CC_MANUAL_CHECK_LIMIT) > 0 && $urlparam['amount'] >= trim(MODULE_PAYMENT_NOVALNET_CC_MANUAL_CHECK_LIMIT)) { // If condition true then order proceed on-hold transaction
                $urlparam['on_hold'] = 1;
            }
    ...
    function payment_action(){
        ...
        if ((MODULE_PAYMENT_NOVALNET_CC_3D_SECURE == 'True' || MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE == 'True' )&& $_SESSION['novalnet'][$this->code]['novalnet_ccchange_account'] != '1') { // To process redirection method
            $param_inputs = array_merge((array) $order, $_SESSION['novalnet'][$this->code]);
            //To get novalnet common payment params
    ...
    function install() {
		...
		('MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE','False', '6', '4', 'xtc_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE,),\'MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE\'," . 'MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE' . ",' ,'',now()),        
