...
class novalnet_cc {
	...
	function doPaymentCall($order_no = '') {
		...
		&& NovalnetHelper::getOrderAmount($order->info['total']) >= (defined('MODULE_PAYMENT_NOVALNET_CC_MANUAL_CHECK_LIMIT') ? MODULE_PAYMENT_NOVALNET_CC_MANUAL_CHECK_LIMIT : '')) { // Authorize transaction
