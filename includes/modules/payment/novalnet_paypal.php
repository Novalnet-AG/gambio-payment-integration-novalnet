...
class novalnet_paypal {
	...
	function __construct() {
		...
		$this->sort_order 		= defined('MODULE_PAYMENT_NOVALNET_PAYPAL_SORT_ORDER') && MODULE_PAYMENT_NOVALNET_PAYPAL_SORT_ORDER != '' ? trim(MODULE_PAYMENT_NOVALNET_PAYPAL_SORT_ORDER) : 0;
	...
	function install() {
		...
		xtc_db_query("insert into `gx_configurations` (`key`, `value`, `sort_order`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_PAYPAL_SORT_ORDER', '20', '10', now()) ");
