...
class novalnet_paypal {
    ...
    function selection() {
        ...
        $test_mode       .=  MODULE_PAYMENT_NOVALNET_PAYPAL_SHOP_TYPE == 'ZEROAMOUNT' ? '<br>'.MODULE_PAYMENT_NOVALNET_ZERO_AMOUNT_TEXT : '';
