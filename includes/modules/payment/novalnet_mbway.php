...
class novalnet_mbway {
	...
	function selection() {
		...
		$selection = [
			'id'          => $this->code,
			'module'      => $this->title,
			'description' => '<link rel="stylesheet" type="text/css" href="ext/novalnet/css/novalnet.css">'.'<script type=text/javascript src="' . DIR_WS_CATALOG . 'ext/novalnet/js/novalnet.js"></script>'. NovalnetHelper::showPaymentDescription($this->code) . $this->info,
		];
		$selection['fields'][] = [
