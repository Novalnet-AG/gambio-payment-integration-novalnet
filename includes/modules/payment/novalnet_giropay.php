...
class novalnet_giropay {
    ...
    public function __construct() {
        ...
        $this->title        = 'Novalnet '. MODULE_PAYMENT_NOVALNET_GIROPAY_TEXT_TITLE;
        ...
        if (strpos(MODULE_PAYMENT_INSTALLED, $this->code) !== false) {
            ...
            $this->enabled         = (MODULE_PAYMENT_NOVALNET_GIROPAY_ENABLE_MODULE == 'True');
            $this->test_mode       = (MODULE_PAYMENT_NOVALNET_GIROPAY_TEST_MODE == 'True'); // To check the test mode
            $this->tmpOrders       = true;
    ...
    function install() {
        ...
        ('MODULE_PAYMENT_NOVALNET_GIROPAY_ENABLE_MODULE','False', '6', '2', 'xtc_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE),\'MODULE_PAYMENT_NOVALNET_GIROPAY_ENABLE_MODULE\'," . MODULE_PAYMENT_NOVALNET_GIROPAY_ENABLE_MODULE . ",' , '',now()),
        ...
        ('MODULE_PAYMENT_NOVALNET_GIROPAY_TRANS_REFERENCE1', '', '6', '9', '',  '', now()),
        ('MODULE_PAYMENT_NOVALNET_GIROPAY_TRANS_REFERENCE2', '', '6', '10', '',  '', now())");
    }
