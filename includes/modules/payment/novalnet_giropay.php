...
class novalnet_giropay
{
	...
	function __construct() {
		...
		$this->description  = ((defined('MODULE_PAYMENT_NOVALNET_GIROPAY_TEXT_TITLE')) ? MODULE_PAYMENT_NOVALNET_GIROPAY_TEXT_TITLE : '');
		...
		$this->sort_order 	= defined('MODULE_PAYMENT_NOVALNET_GIROPAY_SORT_ORDER') && MODULE_PAYMENT_NOVALNET_GIROPAY_SORT_ORDER != '' ? trim(MODULE_PAYMENT_NOVALNET_GIROPAY_SORT_ORDER) : 0;
	...
	function install() {
		...
		xtc_db_query("insert into `gx_configurations` (`key`, `value`, `sort_order`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_GIROPAY_SORT_ORDER', '16', '7', now()) ");
