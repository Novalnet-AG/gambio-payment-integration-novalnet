...
class novalnet_bancontact
{
	...
	function __construct() {
		global $order;
		$this->code      	= 'novalnet_bancontact';
		$this->title     	= ((defined('MODULE_PAYMENT_NOVALNET_BANCONTACT_TEXT_TITLE')) ? MODULE_PAYMENT_NOVALNET_BANCONTACT_TEXT_TITLE : '');
		$this->description  = ((defined('MODULE_PAYMENT_NOVALNET_BANCONTACT_TEXT_TITLE')) ? MODULE_PAYMENT_NOVALNET_BANCONTACT_TEXT_TITLE : '');
		...
		$this->sort_order 	= (defined('MODULE_PAYMENT_NOVALNET_BANCONTACT_SORT_ORDER') && MODULE_PAYMENT_NOVALNET_BANCONTACT_SORT_ORDER != '') ? trim(MODULE_PAYMENT_NOVALNET_BANCONTACT_SORT_ORDER) : 0;
	...
	function install() {
		...
		xtc_db_query("insert into `gx_configurations` (`key`, `value`,  `sort_order`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_BANCONTACT_SORT_ORDER', '25', '7', now()) ");
