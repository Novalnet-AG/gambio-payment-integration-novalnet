...
class novalnet_prepayment {
    ...
    function install() {
		...
		('configuration/MODULE_PAYMENT_NOVALNET_PREPAYMENT_ALLOWED', '', '6', '1', '',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PREPAYMENT_ALIAS', 'NN_PREPAY', '6', '0', '',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PREPAYMENT_STATUS','false', '6', '2', 'switcher',now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PREPAYMENT_TEST_MODE','false', '6', '3', 'switcher', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PREPAYMENT_VISIBILITY_BY_AMOUNT', '', '6', '4','', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PREPAYMENT_ENDCUSTOMER_INFO', '', '6', '5','', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PREPAYMENT_SORT_ORDER', '0', '6', '6', '', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PREPAYMENT_ORDER_STATUS', '0',  '6', '7', 'order-status', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PREPAYMENT_CALLBACK_ORDER_STATUS', '0',  '6', '8', 'order-status', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_ZONE', '0', '6', '9', 'geo-zone',now())
		 ");
	 }else{
