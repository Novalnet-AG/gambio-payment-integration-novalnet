...
class novalnet_prepayment {
    ...
    public function __construct() {
        ...
        if (strpos(MODULE_PAYMENT_INSTALLED, $this->code) !== false) {
            ...
            $this->enabled   = ((defined('MODULE_PAYMENT_NOVALNET_PREPAYMENT_ENABLE_MODULE') && MODULE_PAYMENT_NOVALNET_PREPAYMENT_ENABLE_MODULE == 'True')?  true : false);
    ...
    function selection() {
        ...
        $selection  = array(
                'id'		  => $this->code,
                'module' 	  => $title,
                'description' => MODULE_PAYMENT_NOVALNET_INV_PRE_DESC . '<br>' . $test_mode . '<br>' . $endcustomerinfo);
		if($shop_version > '3810') {
    ...
    function install() {
      ...
      VALUES
        ...
        ('MODULE_PAYMENT_NOVALNET_PREPAYMENT_ENABLE_MODULE','False', '6', '2', 'xtc_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE),\'MODULE_PAYMENT_NOVALNET_PREPAYMENT_ENABLE_MODULE\'," .'MODULE_PAYMENT_NOVALNET_PREPAYMENT_ENABLE_MODULE'. ",' , '',now()),
        ...
        ('MODULE_PAYMENT_NOVALNET_PREPAYMENT_TRANS_REFERENCE1', '', '6', '10', '',  '', now()),
        ('MODULE_PAYMENT_NOVALNET_PREPAYMENT_TRANS_REFERENCE2', '', '6', '11', '',  '', now()),
        ('MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE1','True', '6', '12', 'xtc_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE),\'MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE1\'," .'MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE1'. ",' , '', now()),
        ('MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE2','True', '6', '13', 'xtc_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE),\'MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE2\'," .'MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE2'. ",' , '', now()),
        ('MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE3','True', '6', '14', 'xtc_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE),\'MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE3\'," .'MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE3'. ",' , '', now())");
    }
    ...
    function keys() {
	    ...
	    $return_key = array_merge(array(
            ...
            'MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE1',
            'MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE2',
            'MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE3',
            'MODULE_PAYMENT_NOVALNET_PREPAYMENT_TRANS_REFERENCE1',
            'MODULE_PAYMENT_NOVALNET_PREPAYMENT_TRANS_REFERENCE2',
        ),$alias_menu);
        foreach ($return_key as $key => $value) {
            if( ($gx_version >= '3.1.1.0' && $value == 'MODULE_PAYMENT_NOVALNET_PREPAYMENT_ALIAS')) {
