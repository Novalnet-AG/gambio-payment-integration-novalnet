...
class novalnet_gateway
{
    ...
    public function pre_confirmation_check()
    {
        ...
        if (($this->code == 'novalnet_cc' && !empty($_REQUEST['nn_pan_hash']) && !empty($_REQUEST['nn_uniqueid']))
            || (in_array($this->code, ['novalnet_sepa', 'novalnet_guarantee_sepa', 'novalnet_instalment_sepa']) && !empty($_REQUEST[$this->code . '_iban']) && !empty($_REQUEST[$this->code . '_holder']))
            || ($this->code == 'novalnet_direct_debit_ach' && !empty($_REQUEST[$this->code . '_account_no']) && !empty($_REQUEST[$this->code . '_routing_no']))
