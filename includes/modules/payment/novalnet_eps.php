...
class novalnet_eps {
    ...
    function install() {
		...
		('configuration/MODULE_PAYMENT_NOVALNET_EPS_ALLOWED', '', '6', '1', '', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_EPS_ALIAS', 'NN_EPS', '6', '0', '', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_EPS_STATUS','false', '6', '2',  'switcher',now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_EPS_TEST_MODE','false', '6', '3',  'switcher', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_EPS_VISIBILITY_BY_AMOUNT', '', '6', '4','',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_EPS_ENDCUSTOMER_INFO', '', '6', '5','',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_EPS_SORT_ORDER', '0', '6', '6', '',  now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_EPS_ORDER_STATUS', '0',  '6', '7', 'order-status', now()),
        ('configuration/MODULE_PAYMENT_NOVALNET_EPS_PAYMENT_ZONE', '0', '6', '8', 'geo-zone',now())
		 ");
	 }else{
