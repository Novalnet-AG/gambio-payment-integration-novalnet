...
class novalnet_sepa {
	...
	function before_process() {
		...
		&& (NovalnetHelper::getOrderAmount($order->info['total']) >= (defined('MODULE_PAYMENT_NOVALNET_SEPA_MANUAL_CHECK_LIMIT') ? MODULE_PAYMENT_NOVALNET_SEPA_MANUAL_CHECK_LIMIT : ''))) { // Authorize transaction
