...
class novalnet_sepa {
			...
			if($shop_version > '3810') {
				...
				if (!empty($_SESSION['novalnet'][$this->code]['guarantee']) && (($order->billing['company'] == '') || ($order->billing['company'] != '' && MODULE_PAYMENT_NOVALNET_SEPA_ALLOW_B2B == 'false'))) {
					...
					$selection['fields'][] = array(
					    ...
					    'field' => '<div>'.xtc_draw_hidden_field('', MODULE_PAYMENT_NOVALNET_BIRTH_DATE , 'id="nn_dob_placeholder"').xtc_draw_input_field($this->code . '_dob', $customer_dbvalue['customers_dob'], 'id="' . $this->code . '_dob" AUTOCOMPLETE=off').'</div>
    ...
    function before_process() {
        ...
        $param_inputs              = array_merge((array) $order, $_SESSION['novalnet'][$this->code]);
            ...
            if (!empty($_SESSION['novalnet'][$this->code]['nn_payment_ref_tid_sepa']) && $_SESSION['novalnet'][$this->code]['novalnet_sepachange_account'] == '0'  && $this->shop_type == 'ONECLICK' ) { // To process payment ref
                ...
                $_SESSION['novalnet'][$this->code]['reference_transaction'] = 1;
                unset($_SESSION['novalnet'][$this->code]['nn_payment_ref_tid_sepa'],$urlparam['create_payment_ref']);
            } else {
             ...
             //change the zero amount  dob not matched
            if($urlparam['payment_type'] == 'DIRECT_DEBIT_SEPA' && $this->shop_type == 'ZEROAMOUNT'){
				$urlparam['amount'] = '0';
				$urlparam['create_payment_ref'] = '1';
    ...
    function install() {
		if($_SESSION['GX'] == '1'){
			 ...
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_ALLOWED', '', '1',  now()) ");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_ALIAS', 'NN_SEPA',  '0',   now()) ");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_STATUS','false', '2',  'switcher',now()) ");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_TEST_MODE','false',  '3', 'switcher', now()) ");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_AUTHENTICATE' , 'false', '4', 'switcher' , now()) ");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_MANUAL_CHECK_LIMIT', '',  '7',  now())");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_PAYMENT_DUE_DATE', '',  '6', now()) ");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_SHOP_TYPE_CLICK','' ,  '1', 'switcher' , now()) ");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_ZERO_AMOUNT','' , '1', 'switcher' , now()) ");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_ALLOW_B2B', 'true',  '7', 'switcher', now()) ");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_VISIBILITY_BY_AMOUNT', '', '10', now())");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_ENDCUSTOMER_INFO', '',  '11', now())");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_SORT_ORDER', '0', '12',  now())");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_ORDER_STATUS', '0',  '13', 'order-status', now()) ");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_PAYMENT_ZONE', '0', '14', 'geo-zone',now())");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_GUARANTEE','false', '17',  'switcher', now()) ");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`,  `last_modified`) values  ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_GUARANTEE_MINIMUM_ORDER_AMOUNT', '999',  '18', now())");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_PENDING_ORDER_STATUS', '0',  '13', 'order-status', now()) ");
			 xtc_db_query("insert into `gx_configurations` ( `key`, `value`,   `sort_order`, `type`, `last_modified`) values ('configuration/MODULE_PAYMENT_NOVALNET_SEPA_FORCE','true',  '20', 'switcher', now()) ");
        ...
        ('MODULE_PAYMENT_NOVALNET_SEPA_GUARANTEE_MINIMUM_ORDER_AMOUNT', '999', '6', '18','',  '', now()),
