...
class novalnet_sepa {
    ...
    public function __construct() {
        ...
        if (strpos(MODULE_PAYMENT_INSTALLED, $this->code) !== false) {
            ...
            $this->enabled      = ((defined('MODULE_PAYMENT_NOVALNET_SEPA_ENABLE_MODULE') && MODULE_PAYMENT_NOVALNET_SEPA_ENABLE_MODULE == 'True') ? true : false);
            $this->fraud_module = ((defined('MODULE_PAYMENT_NOVALNET_SEPA_ENABLE_FRAUDMODULE') && MODULE_PAYMENT_NOVALNET_SEPA_ENABLE_FRAUDMODULE == 'False') ? false : true);
