...
class novalnet_instalment_sepa
{
	...
	function selection() {
		...
		$selection = [
			'id'          => $this->code,
			'module'      => $this->title,
			'description' => '<link rel="stylesheet" type="text/css" href="ext/novalnet/css/novalnet.css"><script type=text/javascript src="' . DIR_WS_CATALOG . 'ext/novalnet/js/novalnet_instalment.js"></script>'.NovalnetHelper::showSepaDescription($this->code) . $this->info
	...
	function keys() {
		...
		echo '<input type="hidden" name="nn_instalment_sepa_cycle[]" id="nn_instalment_sepa_cycle" value= "'.$cycles_display.'" />';
		return array(
