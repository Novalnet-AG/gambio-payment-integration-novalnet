					...
					$selection = [
							...
							'description' => '<link rel="stylesheet" type="text/css" href="ext/novalnet/css/novalnet.css">' .NovalnetHelper::showPaymentDescription($this->code) . $this->info
											 ...
											 .'<script src="https://cdn.novalnet.de/js/v3/payment.js"></script>'
											  .'<script src="' . DIR_WS_CATALOG . 'ext/novalnet/js/novalnet_wallet.js" type="text/javascript"></script>'.$this->getParam($order).xtc_draw_hidden_field('nn_googlepay_estotal_label', (defined('MODULE_PAYMENT_NOVALNET_GOOGLEPAY_ESTIMATEDTOTAL_LABEL') ? MODULE_PAYMENT_NOVALNET_GOOGLEPAY_ESTIMATEDTOTAL_LABEL : ''), 'id="nn_googlepay_estotal_label"').xtc_draw_hidden_field('nn_googlepay_total_label', (defined('MODULE_PAYMENT_NOVALNET_GOOGLEPAY_TOTAL_LABEL') ? MODULE_PAYMENT_NOVALNET_GOOGLEPAY_TOTAL_LABEL : ''), 'id="nn_googlepay_total_label"')
						 ];
