...
class novalnet_guarantee_sepa {
	...
	function before_process() {
		...
		if($this->code == 'novalnet_sepa'){
			if ((defined('MODULE_PAYMENT_NOVALNET_SEPA_AUTHENTICATE') && MODULE_PAYMENT_NOVALNET_SEPA_AUTHENTICATE == 'true') && (NovalnetHelper::getOrderAmount($order->info['total']) >= (defined('MODULE_PAYMENT_NOVALNET_SEPA_MANUAL_CHECK_LIMIT') ? MODULE_PAYMENT_NOVALNET_SEPA_MANUAL_CHECK_LIMIT : ''))) { // Authorize transaction
