...
<a href="https://www.novalnet.de/">Novalnet</a> merchant account is required for processing all international and local payments through this Gambio payment module. The module is available for Gambio versions: 4.2.0.0 to 5.0.2.0 in the following languages: <b>EN, DE</b>
...
* Zero amount authorization supported for Credit/Debit card, Direct Debit SEPA, Direct Debit ACH, Apple Pay & Google Pay
