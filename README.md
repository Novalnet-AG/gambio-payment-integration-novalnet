...
<a href="https://www.novalnet.de/">Novalnet</a> merchant account is required for processing all international and local payments through this Gambio payment module. The module is available for Gambio versions gambio_4.2.0.0 to 4.9.2.0 in the following languages: <b>EN, DE</b>
...
## More information
Find more about gambio module on: https://www.novalnet.de/site_pdf/Installation_Guide-gambio_4.2.0.0-4.9.0.2_novalnet_12.1.0.pdf<br>
