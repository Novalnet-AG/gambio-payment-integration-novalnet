...
class NovalnetHelper {
	...
	public static function getTransactionData($receivedData = '') {
		...
		$data['transaction'] = [
			...
			'system_name'      => 'Gambio',
			'system_version'   => $gx_version . '-NN12.3.0',
	...
	*/
	...
	public static function includeAdminJS($payment_code, $authorize = false) {
		if (isset($_GET['module']) && $_GET['module'] == $payment_code && isset($_GET['action']) && $_GET['action'] == 'edit') {
			echo '<script src="' . DIR_WS_CATALOG . 'ext/novalnet/js/novalnet.min.js" type="text/javascript"  integrity="sha384-SxtS3vHoNA4+zyW8sg8iegNlE5mEYZ3JGr+8OpB1Zxwa4GUp838a+zfUX6UU/qJB"></script>';
			if ($authorize) {
