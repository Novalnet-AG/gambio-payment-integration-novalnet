...
class NovalnetHelper
{
     ...
     * @var array
     */
    private $nnRedirectPayments = ['novalnet_paypal', 'novalnet_online_bank_transfer', 'novalnet_ideal', 'novalnet_przelewy24', 'novalnet_eps', 'novalnet_postfinance_card', 'novalnet_postfinance', 'novalnet_bancontact', 'novalnet_trustly', 'novalnet_alipay', 'novalnet_wechatpay', 'novalnet_blik', 'novalnet_twint', 'novalnet_mbway', 'novalnet_payconiq'];
    ...
    public function includeAdminJS($payment_code)
    {
        if (isset($_GET['module']) && $_GET['module'] == $payment_code && isset($_GET['action']) && $_GET['action'] == 'edit') {
            echo '<script src="' . DIR_WS_CATALOG . 'ext/novalnet/js/novalnet.min.js" type="text/javascript" integrity="sha384-uurFr5a+zAdQJavqeOs+n4bN+3/AqP1EQGdkJjiKn2PK7soDRZguCgY9kb7eXrq0" ></script>';
    ...
    public function showPaymentDescription(string $payment_code)
    {
        ...
        if (in_array($payment_code, $this->getFormTypePayments())) {
            ...
            <script type="text/javascript" src="' . DIR_WS_CATALOG . 'ext/novalnet/js/novalnet_payment.min.js" integrity="sha384-UMreH8Gi70pNs8US+xBNnjWXwhe/eLMaSz8eU+IQwC6RRWD8JKusRXKFS5pKmXgo" ></script>
