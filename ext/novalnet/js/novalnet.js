...
function novalnet_load() {
    ...
    if (e.module && e.action && "edit" == e.action) {
        ...
        $('input[name="configuration[configuration/MODULE_PAYMENT_NOVALNET_INVOICE_DUE_DATE]"]').attr('type', 'number');
        $('input[name="configuration[configuration/MODULE_PAYMENT_NOVALNET_INVOICE_DUE_DATE]"]').attr('min', 7);

        $('input[name="configuration[configuration/MODULE_PAYMENT_NOVALNET_PREPAYMENT_DUE_DATE]"]').attr('type', 'number');
        $('input[name="configuration[configuration/MODULE_PAYMENT_NOVALNET_PREPAYMENT_DUE_DATE]"]').attr('min', 7);
        $('input[name="configuration[configuration/MODULE_PAYMENT_NOVALNET_PREPAYMENT_DUE_DATE]"]').attr('max', 28);

        $('input[name="configuration[configuration/MODULE_PAYMENT_NOVALNET_SEPA_DUE_DATE]"]').attr('type', 'number');
        $('input[name="configuration[configuration/MODULE_PAYMENT_NOVALNET_SEPA_DUE_DATE]"]').attr('min', 3);
        $('input[name="configuration[configuration/MODULE_PAYMENT_NOVALNET_SEPA_DUE_DATE]"]').attr('max', 14);
