	...
	jQuery('input[name="payment"]').click(function() {
		if(jQuery(this).val() == 'novalnet_cc') {
			if(document.querySelector('#novalnet_iframe')){
				document.querySelector('#novalnet_iframe').parentElement.classList.remove('col-md-8');
				document.querySelector('#novalnet_iframe').parentElement.classList.add('col-md-12');
			}
		}
	});
