CREATE TABLE IF NOT EXISTS novalnet_transaction_detail (
  ...
  refund_amount int(11) COMMENT 'Refunded amount',
...
INSERT INTO novalnet_version_detail VALUES ('12.4.0');
UPDATE `novalnet_version_detail` SET `version` =  '12.4.0' WHERE `version` !=  '12.4.0';
