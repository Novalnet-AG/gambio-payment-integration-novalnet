		...
		<div class ="frame-wrapper">
			<div class="frame-head">
				...
				<table style="width:100%" >
					<?php
						if (in_array($datas['payment_id'], array(27,33,41,49,50,69))) {
					?>
					<tr>
						<td>
							<?php echo MODULE_PAYMENT_NOVALNET_REFUND_PAYMENTTYPE_TITLE;
							echo xtc_draw_input_field('refund_payment_type', 'NONE', "onclick=refund_process('none'); id='refund_payment_type_none' checked",false,'radio'). MODULE_PAYMENT_NOVALNET_PAYMENTTYPE_NONE;
							echo xtc_draw_input_field('refund_payment_type', 'SEPA', 'onclick="refund_process();" id="refund_payment_type_sepa"',false,'radio'). MODULE_PAYMENT_NOVALNET_SEPA_TEXT;
							?>:
						</td>
					</tr>
					<?php
				...
				<table id="direct_debit_sepa_tabletr"  style= "width:31%; display:none">
					<tr>
						<td style="width:200px;">
							<?php echo MODULE_PAYMENT_NOVALNET_ACCOUNT_HOLDER; ?>
						</td>
						<td>
							<?php echo xtc_draw_input_field('refund_payment_type_accountholder',$order->customer['name'],'id="refund_payment_type_accountholder" onkeypress="return account_holder_validate_extension(event,true)" style="margin:0% 0% 0% 30%" autocomplete="off"');?>
						</td>
					</tr>
					<tr>
						<td style="width:200px;">
							<?php echo MODULE_PAYMENT_NOVALNET_IBAN; ?>
						</td>
						<td>
							<?php echo xtc_draw_input_field('refund_payment_type_iban','','id="refund_payment_type_iban" onkeypress="return ibanbic_validate_extension(event,false)" style="margin:0% 0% 0% 30%" autocomplete="off"');?>
						</td>
					</tr>
					<tr>
						<td style="width:200px;">
							<?php echo MODULE_PAYMENT_NOVALNET_BIC; ?>
						</td>
						<td>
							<?php echo xtc_draw_input_field('refund_payment_type_bic','','id="refund_payment_type_bic" onkeypress="return ibanbic_validate_extension(event,false)" style="margin:0% 0% 0% 30%" autocomplete="off"');?>
						</td>
					</tr>
				</table>
				<table style="width=31%">
...
<div class="content article-table grid">
	...
	if(($datas['payment_id'] == 37 && $datas['gateway_status'] == 99) || ($datas['payment_id'] == 27 && $datas['gateway_status'] == 100 && $callback_info['callback_total_amount'] <  $callback_info['order_amount'])) {
...
<div class="content article-table grid">
	<div class="span12 remove-padding">
		<div class ="frame-wrapper">
			<div class="frame-head">
				<label class="title" ><?php echo ($datas['payment_id'] == 37) ? MODULE_PAYMENT_NOVALNET_AMOUNT_CHANGE_TITLE : MODULE_PAYMENT_NOVALNET_AMOUNT_CHANGE_DUE_DATE_TITLE; ?></label>
			</div>
				...
				<table>
					...
					<tr>
						<td>
							<?php echo MODULE_PAYMENT_NOVALNET_TRANS_DUE_DATE_TITLE; ?>
						</td>
						<td>
						...
						<?php echo xtc_draw_hidden_field('invoice_payment_due_date', $orderInfo['due_date']);
							  echo xtc_draw_hidden_field('invoice_payment', $invoice_prepayment_payment);
							  echo xtc_draw_hidden_field('nn_duedate_update', MODULE_PAYMENT_NOVALNET_ORDER_AMT_DATE_UPDATE_TEXT);
