				...
				<?php
                  ...
                  // Custom sorting function
                   function sortByNextInstalmentDate($a, $b) {
                       $dateA = empty($a['next_instalment_date']) ? PHP_INT_MAX : strtotime($a['next_instalment_date']);
                       $dateB = empty($b['next_instalment_date']) ? PHP_INT_MAX : strtotime($b['next_instalment_date']);
                       return $dateA - $dateB;
                      }
