...
define('MODULE_PAYMENT_NOVALNET_INSTANTBANK_TEXT_TITLE', 'Sofortüberweisung');
define('MODULE_PAYMENT_NOVALNET_INSTANTBANK_REDIRECT_DESC','Sie werden zu Sofortüberweisung weitergeleitet. Um eine erfolgreiche Zahlung zu gewährleisten, darf die Seite nicht geschlossen oder neu geladen werden, bis die Bezahlung abgeschlossen ist');
...
define('MODULE_PAYMENT_NOVALNET_INSTANTBANK_STATUS_TITLE','Zahlungsart anzeigen');
...
define('MODULE_PAYMENT_NOVALNET_INSTANTBANK_SORT_ORDER_TITLE','Anzeigereihenfolge');
define('MODULE_PAYMENT_NOVALNET_INSTANTBANK_SORT_ORDER_DESC','Reihenfolge der Anzeige. Kleinste Ziffer wird zuerst angezeigt.');
...
define('MODULE_PAYMENT_NOVALNET_INSTANTBANK_PAYMENT_ZONE_DESC','Wenn eine Zone ausgewählt ist, gilt die Zahlungsmethode nur für diese Zone.');
