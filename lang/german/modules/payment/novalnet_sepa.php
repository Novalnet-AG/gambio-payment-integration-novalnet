...
define('MODULE_PAYMENT_NOVALNET_SEPA_FORM_MANDATE_CONFIRM_TEXT', '<strong> Hiermit erteile ich das SEPA-Lastschriftmandat und best&auml;tige, dass die angegebene IBAN und BIC korrekt sind.</strong>');
