...
define('MODULE_PAYMENT_NOVALNET_CC_TEXT_TITLE', 'Novalnet Kreditkarte');
...
define('MODULE_PAYMENT_NOVALNET_CC_PUBLIC_TITLE', 'Kreditkarte '. (((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True')?'<a href="https://www.novalnet.de" target="_blank"/><img title="Kreditkarte" alt="Kreditkarte" src="'.DIR_WS_ICONS.'novalnet/novalnet_cc_visa.png" width=11%><img title="Kreditkarte" alt="Kreditkarte" src="'.DIR_WS_ICONS.'novalnet/novalnet_cc_master.png" width=12% ></a>':'').
