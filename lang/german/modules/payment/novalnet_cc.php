...
define('MODULE_PAYMENT_NOVALNET_CC_AUTHENTICATE_DESC','Wählen Sie, ob die Zahlung sofort belastet werden soll oder nicht. Authorize prüft die Zahlungsdetails und reserviert Mittel, um sie später zu erfassen, damit der Händler Zeit hat, über die Bestellung zu entscheiden.</br></br> Zahlung autorisieren');
...
define('MODULE_PAYMENT_NOVALNET_CC_PENDING_ORDER_STATUS_TITLE','Auftragsstatus für die ausstehende Zahlung');
define('MODULE_PAYMENT_NOVALNET_CC_PENDING_ORDER_STATUS_DESC','&nbsp;');
