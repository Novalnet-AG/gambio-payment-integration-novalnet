...
define('MODULE_PAYMENT_NOVALNET_DIRECT_DEBIT_ACH_AUTHENTICATE_TITLE', 'Aktion für vom Besteller autorisierte Zahlungen');
define('MODULE_PAYMENT_NOVALNET_DIRECT_DEBIT_ACH_AUTHENTICATE_DESC', 'Wählen Sie, ob die Zahlung sofort belastet werden soll oder nicht. Authorize prüft die Zahlungsdetails und reserviert Mittel, um sie später zu erfassen, damit der Händler Zeit hat, über die Bestellung zu entscheiden.</br></br> Mit Nullbetrag autorisieren');
...
define('MODULE_PAYMENT_NOVALNET_DIRECT_DEBIT_ACH_NEW_ACCOUNT_DETAILS', 'Neue Kontodaten hinzufügen');
