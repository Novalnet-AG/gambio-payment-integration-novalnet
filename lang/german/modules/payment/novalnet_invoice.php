...
define('MODULE_PAYMENT_NOVALNET_INVOICE_ENABLE_MODULE_TITLE','Zahlungsart aktivieren');
...
define('MODULE_PAYMENT_NOVALNET_INVOICE_TRANS_REFERENCE1_TITLE','1. Referenz zur Transaktion');
define('MODULE_PAYMENT_NOVALNET_INVOICE_TRANS_REFERENCE1_DESC','Diese Referenz wird auf Ihrem Kontoauszug erscheinen');
define('MODULE_PAYMENT_NOVALNET_INVOICE_TRANS_REFERENCE2_TITLE','2. Referenz zur Transaktion');
define('MODULE_PAYMENT_NOVALNET_INVOICE_TRANS_REFERENCE2_DESC','Diese Referenz wird auf Ihrem Kontoauszug erscheinen');
define('MODULE_PAYMENT_NOVALNET_INVOICE_PAYMENT_REFERENCE1_TITLE','Verwendungszweck 1: (Novalnet Rechnungsnummer)');
define('MODULE_PAYMENT_NOVALNET_INVOICE_PAYMENT_REFERENCE1_DESC','');
define('MODULE_PAYMENT_NOVALNET_INVOICE_PAYMENT_REFERENCE2_TITLE','Verwendungszweck 2: (TID)');
define('MODULE_PAYMENT_NOVALNET_INVOICE_PAYMENT_REFERENCE2_DESC','');
define('MODULE_PAYMENT_NOVALNET_INVOICE_PAYMENT_REFERENCE3_TITLE','Verwendungszweck 3: (Bestellnummer)');
define('MODULE_PAYMENT_NOVALNET_INVOICE_PAYMENT_REFERENCE3_DESC','');
define('MODULE_PAYMENT_NOVALNET_INVOICE_GUARANTEE_TITLE','<h2>Einstellungen für die Zahlungsgarantie</h2><h3>Grundanforderungen für die Zahlungsgarantie</h3>Zugelassene Staaten: AT, DE, CH <br>Zugelassene Währung: EUR <br> Mindestbetrag der Bestellung >= 20,00 EUR <br>Maximalbetrag der Bestellung <= 5.000,00 EUR <br> Mindestalter des Endkunden >= 18 Jahre <br> Rechnungsadresse und Lieferadresse müssen übereinstimmen <br> Geschenkgutscheine / Coupons sind nicht erlaubt<br><br>Zahlungsgarantie aktivieren');
...
define('MODULE_PAYMENT_NOVALNET_INVOICE_GUARANTEE_MINIMUM_ORDER_AMOUNT_DESC','Diese Einstellung wird den Standardwert für den Mindestbestellbetrag überschreiben. Beachten Sie, dass der Betrag im Bereich von 20,00 EUR – 5.000,00 EUR liegen muss.');
define('MODULE_PAYMENT_NOVALNET_INVOICE_GUARANTEE_MAXIMUM_ORDER_AMOUNT_TITLE','Maximaler Bestellbetrag (in der kleinsten Währungseinheit, z.B. 100 Cent = entsprechen 1.00 EUR)');
define('MODULE_PAYMENT_NOVALNET_INVOICE_GUARANTEE_MAXIMUM_ORDER_AMOUNT_DESC','Diese Einstellung wird den Standardwert für den Maximal-Bestellbetrag überschreiben. Beachten Sie, dass dieser Betrag größer als der Mindestbestellbetrag sein sollte, jedoch nicht höher als 5.000,00 EUR.');
...
define('MODULE_PAYMENT_NOVALNET_INVOICE_GUARANTEE_MINIMUM_AMOUNT_ERROR','Der Mindestbetrag sollte bei mindestens 20,00 EUR liegen, jedoch nicht mehr als 5.000,00 EUR');
define('MODULE_PAYMENT_NOVALNET_INVOICE_GUARANTEE_MAXIMUM_AMOUNT_ERROR','Der Maximalbetrag sollte größer sein als der Mindestbestellbetrag, jedoch nicht höher als 5.000,00 EUR');
define('MODULE_PAYMENT_NOVALNET_INVOICE_PUBLIC_TITLE', 'Kauf auf Rechnung  '.(((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True') ? '<a href="https://www.novalnet.de" target="_blank"/><img title="Kauf auf Rechnung " alt="Kauf auf Rechnung " src="'.DIR_WS_ICONS.'novalnet/novalnet_invoice.png" width=3% ></a>':''));
