...
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_SEPA_BASIC_REQ_TITLE', '<h2> Einstellungen für die Zahlungsgarantie</h2><h3>Grundanforderungen:</h3>Erlaubte B2C-Länder: Deutschland, Österreich, Schweiz <br> Erlaubte B2B-Länder: Europäische Union, Schweiz<br>Erlaubte Währung: € <br> Mindestbestellwert: 9,99 € oder mehr <br>Altersgrenze: 18 Jahre oder mehr<br> Die Rechnungsadresse muss die gleiche sein wie die Lieferadresse<br>');
...
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_SEPA_FORM_MANDATE_CONFIRM_TEXT', '<a class="about_mandate" style="cursor:pointer; color:#0080c9;">Ich erteile hiermit das SEPA-Lastschriftmandat (elektronische Übermittlung) und bestätige, dass die Bankverbindung korrekt ist</a>');
...
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_SEPA_TEXT_INFO', 'Der Betrag wird durch Novalnet von Ihrem Konto abgebucht');
