...
define('MODULE_PAYMENT_NOVALNET_GIROPAY_ENABLE_MODULE_TITLE','Zahlungsart aktivieren');
...
define('MODULE_PAYMENT_NOVALNET_GIROPAY_TRANS_REFERENCE1_TITLE','1. Referenz zur Transaktion');
define('MODULE_PAYMENT_NOVALNET_GIROPAY_TRANS_REFERENCE1_DESC','Diese Referenz wird auf Ihrem Kontoauszug erscheinen');
define('MODULE_PAYMENT_NOVALNET_GIROPAY_TRANS_REFERENCE2_TITLE','2. Referenz zur Transaktion');
define('MODULE_PAYMENT_NOVALNET_GIROPAY_TRANS_REFERENCE2_DESC','Diese Referenz wird auf Ihrem Kontoauszug erscheinen');
define('MODULE_PAYMENT_NOVALNET_GIROPAY_TITLE','<b>GIROPAY Konfiguration</b>');
define('MODULE_PAYMENT_NOVALNET_GIROPAY_PUBLIC_TITLE', 'giropay '.(((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True') ? '<a href="https://www.novalnet.de" target="_blank"/><img title="giropay" alt="giropay" src="images/icons/novalnet/novalnet_giropay.png" width=10%></a>':''));
