...
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_ENABLE_MODULE_TITLE','Zahlungsart aktivieren');
...
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_TRANS_REFERENCE1_TITLE','1. Referenz zur Transaktion');
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_TRANS_REFERENCE1_DESC','Diese Referenz wird auf Ihrem Kontoauszug erscheinen');
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_TRANS_REFERENCE2_TITLE','2. Referenz zur Transaktion');
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_TRANS_REFERENCE2_DESC','Diese Referenz wird auf Ihrem Kontoauszug erscheinen');
