...
define('MODULE_PAYMENT_NOVALNET_CONFIG_TEXT_TITLE', 'Novalnet API-Konfiguration (V_12.4.1)');
define('MODULE_PAYMENT_NOVALNET_CONFIG_TEXT_DESC', '<span style="font-weight: bold; color:#878787;"> Bevor Sie beginnen, lesen Sie bitte die Installationsanleitung und melden Sie sich mit Ihrem Händlerkonto im <a href="https://admin.novalnet.de" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet Admin-Portal</a> an. Um ein Händlerkonto zu erhalten, senden Sie bitte eine E-Mail an <a style="font-weight: bold; color:#0080c9" href="mailto:sales@novalnet.de">sales@novalnet.de</a> oder rufen Sie uns unter +49 89 923068320 an</span><br><br>');
define('MODULE_PAYMENT_NOVALNET_SIGNATURE_TITLE', 'Aktivierungsschlüssel des Produkts');
define('MODULE_PAYMENT_NOVALNET_SIGNATURE_DESC', 'Ihren Produktaktivierungsschlüssel finden Sie im <a href="https://admin.novalnet.de" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet Admin-Portal:</a> Projekte > Wählen Sie Ihr Projekt > API-Anmeldeinformationen > API Signature (Aktivierungsschlüssel des Produkts)');
...
define('MODULE_PAYMENT_NOVALNET_CALLBACK_MAIL_TO_TITLE', '<script src="../ext/novalnet/js/novalnet_config.min.js" type="text/javascript" integrity="sha384-izopf67LERaMSCSXKlBotXF8Pm/MTfUwX/Sy9mF+Zx75ubHehsJPeOVN9n2zzThh" ></script> <input type="button" id="webhook_url_button" style="font-weight: bold; color:#0080c9;margin-left: 0px;margin-top: 0px;margin-bottom: 15px;" value="Konfigurieren"> <br> E-Mails senden an');
