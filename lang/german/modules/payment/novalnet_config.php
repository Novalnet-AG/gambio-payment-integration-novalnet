...
define('MODULE_PAYMENT_NOVALNET_CONFIG_TEXT_TITLE', 'Novalnet Haupteinstellungen (V_11.1.0)');
define('MODULE_PAYMENT_NOVALNET_CONFIG_TEXT_DESCRIPTION','<span style="font-weight: bold; color:#878787;"> Um zus&auml;tzliche Einstellungen vorzunehmen, loggen Sie sich in das <a href="'.DIR_WS_CATALOG.'admin/novalnet.php?process=map" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet-H&auml;ndleradministrationsportal</a> ein. <br/>Um sich in das Portal einzuloggen, ben&ouml;tigen Sie einen Account bei Novalnet. Falls Sie diesen noch nicht haben, kontaktieren Sie bitte <a style="font-weight: bold; color:#0080c9" href="mailto:sales@novalnet.de">sales@novalnet.de</a> (Tel: +49 (089) 923068320).</span><br/><br/><span style="font-weight: bold; color:#878787;">Um die Zahlungsart PayPal zu verwenden, geben Sie bitte Ihre PayPal-API-Daten in das <a href="'.DIR_WS_CATALOG.'admin/novalnet.php?process=map" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet-H&auml;ndleradministrationsportal</a> ein.</span>');
define('MODULE_PAYMENT_NOVALNET_PUBLIC_KEY_TITLE', 'Aktivierungsschl&uuml;ssel des Produkts');
define('MODULE_PAYMENT_NOVALNET_PUBLIC_KEY_DESC', 'Novalnet-Aktivierungsschl&uuml;ssel f&uuml;r das Produkt eingeben');
