...
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_DESC','On successful checkout, you will receive a payment slip/SMS to pay your online purchase at one of our retail partners (e.g. supermarket).');
...
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_STATUS_TITLE','Display payment method');
