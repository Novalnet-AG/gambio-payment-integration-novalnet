...
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_ENABLE_MODULE_TITLE','Enable payment method');
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_ENABLE_MODULE_DESC','');
...
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_TRANS_REFERENCE1_TITLE','Transaction reference 1');
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_TRANS_REFERENCE1_DESC','This reference will appear in your bank account statement');
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_TRANS_REFERENCE2_TITLE','Transaction reference 2');
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_TRANS_REFERENCE2_DESC','This reference will appear in your bank account statement');
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_BLOCK_TITLE','<b>Cashpayment Configuration</b>');
define('MODULE_PAYMENT_NOVALNET_CASHPAYMENT_PUBLIC_TITLE', 'Barzahlen '.(((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True') ? '<a href="https://www.novalnet.com" target="_blank"/><img title="Barzahlen" alt="Barzahlen" src="'.DIR_WS_ICONS.'novalnet/novalnet_cashpayment.png" width=9%></a>':''));
