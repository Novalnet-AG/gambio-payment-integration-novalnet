...
define('MODULE_PAYMENT_NOVALNET_EPS_REDIRECT_DESC','You will be redirected to eps. Please don’t close or refresh the browser until the payment is completed');
...
define('MODULE_PAYMENT_NOVALNET_EPS_STATUS_TITLE','Display payment method');
