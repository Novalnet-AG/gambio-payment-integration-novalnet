...
define('MODULE_PAYMENT_NOVALNET_EPS_PUBLIC_TITLE', 'eps '.(((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True') ? '<a href="https://www.novalnet.com" target="_blank"/><img title="eps" alt="eps" src="'.DIR_WS_ICONS.'novalnet/novalnet_eps.png" width=9%></a>':''));
