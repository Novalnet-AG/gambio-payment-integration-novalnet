...
define('MODULE_PAYMENT_NOVALNET_EPS_ENABLE_MODULE_TITLE','Enable payment method');
...
define('MODULE_PAYMENT_NOVALNET_EPS_TRANS_REFERENCE1_TITLE','Transaction reference 1');
define('MODULE_PAYMENT_NOVALNET_EPS_TRANS_REFERENCE1_DESC','This reference will appear in your bank account statement');
define('MODULE_PAYMENT_NOVALNET_EPS_TRANS_REFERENCE2_TITLE','Transaction reference 2');
define('MODULE_PAYMENT_NOVALNET_EPS_TRANS_REFERENCE2_DESC','This reference will appear in your bank account statement');
define('MODULE_PAYMENT_NOVALNET_EPS_PUBLIC_TITLE', 'eps '.(((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True') ? '<a href="http://www.novalnet.com" target="_blank"/><img title="eps" alt="eps" src="'.DIR_WS_ICONS.'novalnet/novalnet_eps.png" width=9%></a>':''));
