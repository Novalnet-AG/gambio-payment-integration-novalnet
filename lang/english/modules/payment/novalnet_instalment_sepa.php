...
define('MODULE_PAYMENT_NOVALNET_INSTALMENT_SEPA_FORM_MANDATE_CONFIRM_TEXT', '<a class="about_mandate" style="cursor:pointer; color:#0080c9;">I hereby grant the mandate for the SEPA direct debit (electronic transmission) and confirm that the given bank details are correct!</a>');
...
define('MODULE_PAYMENT_NOVALNET_INSTALMENT_SEPA_TEXT_INFO', 'The amount will be debited from your account by Novalnet');
