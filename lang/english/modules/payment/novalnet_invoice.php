...
define('MODULE_PAYMENT_NOVALNET_INVOICE_MANUAL_CHECK_LIMIT_TITLE', 'Set a limit for on-hold transaction (in minimum unit of currency. E.g. enter 100 which is equal to 1.00)');
define('MODULE_PAYMENT_NOVALNET_INVOICE_MANUAL_CHECK_LIMIT_DESC', 'In case the order amount exceeds mentioned limit, the transaction will be set on hold till your confirmation of transaction');
...
define('MODULE_PAYMENT_NOVALNET_INVOICE_GUARANTEE_TITLE','<h2>Payment guarantee configuration</h2><h3>Basic requirements for Payment guarantee</h3>Allowed countries: AT, DE, CH <br>Allowed currency: EUR <br> Minimum amount of order >= 20,00 EUR <br>Minimum age of end customer >= 18 Years<br> The billing address must be the same as the shipping address <br> Gift certificates/vouchers are not allowed<br><br>Enable payment guarantee');
...
define('MODULE_PAYMENT_NOVALNET_INVOICE_GUARANTEE_MINIMUM_ORDER_AMOUNT_DESC','This setting will override the default setting made in the minimum order amount. Note: Minimum amount should be greater than or equal to 20,00 EUR.');
...
define('MODULE_PAYMENT_NOVALNET_INVOICE_PENDING_ORDER_STATUS_DESC','This setting will override the default setting made in the minimum order amount. Note: Minimum amount should be greater than or equal to 20,00 EUR.');
define('MODULE_PAYMENT_NOVALNET_INVOICE_GUARANTEE_MINIMUM_AMOUNT_ERROR','The minimum amount should be at least 20,00 EUR');
