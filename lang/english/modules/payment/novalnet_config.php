...
define('MODULE_PAYMENT_NOVALNET_CONFIG_TEXT_TITLE','Novalnet API Configuration (V_12.3.1)');
define('MODULE_PAYMENT_NOVALNET_CONFIG_TEXT_DESC', '<span style="font-weight: bold; color:#878787;">
...
define('MODULE_PAYMENT_NOVALNET_CALLBACK_MAIL_TO_TITLE', '<script src="../ext/novalnet/js/novalnet_config.min.js" type="text/javascript"  integrity="sha384-ucRBXbBxq3IzN1d1LkSW//miLhxDWKppIRHUbJ9RjdLQOboznTjrARN40cZA3i+c"></script> <input type="button" id="webhook_url_button" style="font-weight: bold; color:#0080c9;" value="Configure"> <br> Send e-mail to');
