...
define('MODULE_PAYMENT_NOVALNET_CONFIG_TEXT_TITLE', 'Novalnet Global Configuration (V_11.1.2)');
...
define('MODULE_PAYMENT_NOVALNET_MANUAL_CHECK_LIMIT_DESC', 'In case the order amount exceeds mentioned limit, the transaction will be set on hold till your confirmation of transaction (For PayPal: In order to use this option you must have billing agreement option enabled in your PayPal account. Please contact your account manager at PayPal.)');
...
define('MODULE_PAYMENT_NOVALNET_CALLBACK_TEST_MODE_TITLE', '<h2>Merchant script management</h2>Enable test mode');
