...
define('MODULE_PAYMENT_NOVALNET_CONFIG_TEXT_TITLE', 'Novalnet Global Configuration (V_11.1.1)');
define('MODULE_PAYMENT_NOVALNET_CONFIG_TEXT_DESCRIPTION', '<span style="font-weight: bold; color:#878787;">For additional configurations login to <a href="'.DIR_WS_CATALOG.'admin/novalnet.php?process=map" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet Merchant Administration portal</a>.<br/> To login to the Portal you need to have an account at Novalnet. If you don&#39;t have one yet, please contact <a style="font-weight: bold; color:#0080c9;"href="mailto:sales@novalnet.de">sales@novalnet.de</a> / tel. +49 (089) 923068320</span><br/><br/><span style="font-weight: bold; color:#878787;">To use the PayPal payment method please enter your PayPal API details in <a href="'.DIR_WS_CATALOG.'admin/novalnet.php?process=map" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet Merchant Administration portal</a></span>');
define('MODULE_PAYMENT_NOVALNET_PUBLIC_KEY_TITLE', 'Product activation key');
define('MODULE_PAYMENT_NOVALNET_PUBLIC_KEY_DESC', 'Enter Novalnet Product activation key');
...
define('MODULE_PAYMENT_NOVALNET_MANUAL_CHECK_LIMIT_TITLE', 'Set a limit for on-hold transaction (in minimum unit of currency. E.g. enter 100 which is equal to 1.00)');
define('MODULE_PAYMENT_NOVALNET_MANUAL_CHECK_LIMIT_DESC', 'In case the order amount exceeds mentioned limit, the transaction will be set on hold till your confirmation of transaction');
...
define('MODULE_PAYMENT_NOVALNET_CALLBACK_DEBUG_MODE_TITLE', '<h2>Merchant script management</h2>Enable debug mode');
define('MODULE_PAYMENT_NOVALNET_CALLBACK_DEBUG_MODE_DESC', 'Set the debug mode to execute the merchant script in debug mode');
define('MODULE_PAYMENT_NOVALNET_CALLBACK_TEST_MODE_TITLE', 'Enable test mode');
