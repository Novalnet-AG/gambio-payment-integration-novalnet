...
define('MODULE_PAYMENT_NOVALNET_CONFIG_TEXT_TITLE', 'Novalnet API Configuration (V_12.4.0)');
define(
    'MODULE_PAYMENT_NOVALNET_CONFIG_TEXT_DESC',
    '<span style="font-weight: bold; color:#878787;">
...
define('MODULE_PAYMENT_NOVALNET_SIGNATURE_DESC', 'Get your Product activation key from the <a href="https://admin.novalnet.de" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet Admin Portal:</a> Projects > Choose your project > API credentials > API Signature (Product activation key)');
define('MODULE_PAYMENT_NOVALNET_PAYMENT_ACCESS_KEY_TITLE', 'Payment access key');
define('MODULE_PAYMENT_NOVALNET_PAYMENT_ACCESS_KEY_DESC', 'Get your Payment access key from the <a href="https://admin.novalnet.de" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet Admin Portal:</a> Projects > Choose your project > API credentials > Payment access key');
...
define('MODULE_PAYMENT_NOVALNET_CALLBACK_MAIL_TO_TITLE', '<script src="../ext/novalnet/js/novalnet_config.min.js" type="text/javascript" integrity="sha384-izopf67LERaMSCSXKlBotXF8Pm/MTfUwX/Sy9mF+Zx75ubHehsJPeOVN9n2zzThh" ></script> <input type="button" id="webhook_url_button" style="font-weight: bold; color:#0080c9;margin-left: 0px;margin-top: 0px;margin-bottom: 15px;" value="Configure"> <br> Send e-mail to');
