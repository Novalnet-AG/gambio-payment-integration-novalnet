...
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_SEPA_PENDING_ORDER_STATUS_TITLE','Order status for the pending payment');
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_SEPA_PENDING_ORDER_STATUS_DESC','&nbsp;');
