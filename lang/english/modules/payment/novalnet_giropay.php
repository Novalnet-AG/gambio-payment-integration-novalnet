...
define('MODULE_PAYMENT_NOVALNET_GIROPAY_ENABLE_MODULE_TITLE','Enable payment method');
define('MODULE_PAYMENT_NOVALNET_GIROPAY_ENABLE_MODULE_DESC','');
...
define('MODULE_PAYMENT_NOVALNET_GIROPAY_TRANS_REFERENCE1_TITLE','Transaction reference 1');
define('MODULE_PAYMENT_NOVALNET_GIROPAY_TRANS_REFERENCE1_DESC','This reference will appear in your bank account statement');
define('MODULE_PAYMENT_NOVALNET_GIROPAY_TRANS_REFERENCE2_TITLE','Transaction reference 2');
define('MODULE_PAYMENT_NOVALNET_GIROPAY_TRANS_REFERENCE2_DESC','This reference will appear in your bank account statement');
define('MODULE_PAYMENT_NOVALNET_GIROPAY_TITLE','<b>GIROPAY Configuration</b>');
define('MODULE_PAYMENT_NOVALNET_GIROPAY_PUBLIC_TITLE', 'giropay '.(((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True') ? '<a href="https://www.novalnet.com" target="_blank"/><img title="giropay" alt="giropay" src="images/icons/novalnet/novalnet_giropay.png" width=10%></a>':''));
