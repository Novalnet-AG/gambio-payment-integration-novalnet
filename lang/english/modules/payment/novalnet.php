...
define('MODULE_PAYMENT_NOVALNET_CONFIG_BLOCK_TITLE','<b>Novalnet Global Configuration</b> (V_11.1.7)');
...
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_INVALID_AMOUNT','The payment cannot be processed, because the basic requirements for the payment guarantee haven'."'".'t been met (Minimum order amount must be 9,99 EUR)');
