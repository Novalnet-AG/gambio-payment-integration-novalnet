...
define('MODULE_PAYMENT_NOVALNET_PAYPAL_TEXT_DESCRIPTION', 'The payment will be processed in the test mode therefore amount for this transaction will not be charged');
...
define('MODULE_PAYMENT_NOVALNET_PAYPAL_STATUS_DESC','Do you want to accept paypal payment?');
...
define('MODULE_PAYMENT_NOVALNET_PAYPAL_ORDER_STATUS_DESC','Status to be used for successful orders');
...
define('MODULE_PAYMENT_NOVALNET_PAYPAL_VISIBILITY_BY_AMOUNT_TITLE','Minimum order amount');
define('MODULE_PAYMENT_NOVALNET_PAYPAL_VISIBILITY_BY_AMOUNT_DESC','Minimum order amount to display the selected payment method (s) at during checkout (in minimum unit of currency. E.g. enter 100 which is equal to 1.00)');
...
define('MODULE_PAYMENT_NOVALNET_PAYPAL_AUTHENTICATE_DESC','Choose whether or not the payment should be charged immediately. Authorize verifies payment details and reserves funds to capture it later, giving time for the merchant to decide on the order.</br></br>Authorize');
...
define('MODULE_PAYMENT_NOVALNET_PAYPAL_ACCOUNT_DETAILS', 'PayPal account:  ');
define('MODULE_PAYMENT_NOVALNET_PAYPAL_NEW_ACCOUNT_DETAILS', 'Use a new payment method');
?>
