...
define('MODULE_PAYMENT_NOVALNET_INSTALMENT_INVOICE_TEXT_TITLE', 'Novalnet Instalment by Invoice');
define('MODULE_PAYMENT_NOVALNET_INSTALMENT_INVOICE_BASIC_REQ_TITLE', '<h2>Basic requirements:</h2>Allowed B2B countries: European Union, Switzerland <br> Allowed B2C countries: Germany, Austria, Switzerland <br> Allowed currency: € <br> Minimum order amount: 19,98 € or more <br>Please note that the instalment cycle amount has to be a minimum of 9.99 EUR and the instalment cycles which do not meet this criteria will not be displayed in the instalment plan <br> Age limit: 18 years or more<br> The billing address must be the same as the shipping address<br>');
define('MODULE_PAYMENT_NOVALNET_INSTALMENT_INVOICE_STATUS_TITLE', 'Enable payment method');
define('MODULE_PAYMENT_NOVALNET_INSTALMENT_INVOICE_STATUS_DESC', 'Do you want to accept instalment by invoice payment?');
...
define('MODULE_PAYMENT_NOVALNET_INSTALMENT_INVOICE_ORDER_STATUS_DESC', 'Status to be used for successful orders');
...
define('MODULE_PAYMENT_NOVALNET_INSTALMENT_INVOICE_AUTHENTICATE_DESC', 'Choose whether or not the payment should be charged immediately. Authorize verifies payment details and reserves funds to capture it later, giving time for the merchant to decide on the order.</br></br>Authorize');
