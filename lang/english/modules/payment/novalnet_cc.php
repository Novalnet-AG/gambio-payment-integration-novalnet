...
define('MODULE_PAYMENT_NOVALNET_CC_AUTHENTICATE_DESC','Choose whether or not the payment should be charged immediately. Authorize verifies payment details and reserves funds to capture it later, giving time for the merchant to decide on the order.</br></br>Authorize');
...
define('MODULE_PAYMENT_NOVALNET_CC_PENDING_ORDER_STATUS_TITLE','Order status for the pending payment');
