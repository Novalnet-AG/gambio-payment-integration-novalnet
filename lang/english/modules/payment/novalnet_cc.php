...
define('MODULE_PAYMENT_NOVALNET_CC_PUBLIC_TITLE', 'Credit Card '. (((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True')?'<a href="https://www.novalnet.com" target="_blank"/><img title="Credit Card" alt="Credit Card" src="'.DIR_WS_ICONS.'novalnet/novalnet_cc_visa.png" width=11%><img title="Credit Card" alt="Credit Card" src="'.DIR_WS_ICONS.'novalnet/novalnet_cc_master.png" width=12%></a>':'').
