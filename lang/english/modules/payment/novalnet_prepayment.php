...
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_ENABLE_MODULE_TITLE','Enable payment method');
...
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_SORT_ORDER_TITLE','Define a sorting order');
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_SORT_ORDER_DESC','This payment method will be sorted among others (in the ascending order) as per the given sort number.');
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_ORDER_STATUS_TITLE','Order completion status');
...
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_ZONE_DESC','This payment method will be displayed for the mentioned zone(-s)');
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_TRANS_REFERENCE1_TITLE','Transaction reference 1');
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_TRANS_REFERENCE1_DESC','This reference will appear in your bank account statement');
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_TRANS_REFERENCE2_TITLE','Transaction reference 2');
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_TRANS_REFERENCE2_DESC','This reference will appear in your bank account statement');
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE1_TITLE','Payment Reference 1 (Novalnet Invoice Reference)');
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE1_DESC','');
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE2_TITLE','Payment Reference 2 (TID)');
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE2_DESC','');
define('MODULE_PAYMENT_NOVALNET_PREPAYMENT_PAYMENT_REFERENCE3_TITLE','Payment Reference 3 (Order No)');
