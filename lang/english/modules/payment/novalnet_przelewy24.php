...
define('MODULE_PAYMENT_NOVALNET_PRZELEWY24_TEXT_DESCRIPTION', 'The payment will be processed in the test mode therefore amount for this transaction will not be charged');
define('MODULE_PAYMENT_NOVALNET_PRZELEWY24_STATUS_TITLE', 'Enable payment method');
define('MODULE_PAYMENT_NOVALNET_PRZELEWY24_STATUS_DESC', 'Do you want to accept przelewy24 payment?');
...
define('MODULE_PAYMENT_NOVALNET_PRZELEWY24_ORDER_STATUS_DESC', 'Status to be used for successful orders');
...
define('MODULE_PAYMENT_NOVALNET_PRZELEWY24_VISIBILITY_BY_AMOUNT_TITLE', 'Minimum order amount.');
define('MODULE_PAYMENT_NOVALNET_PRZELEWY24_VISIBILITY_BY_AMOUNT_DESC', 'Minimum order amount to display the selected payment method (s) at during checkout (in minimum unit of currency. E.g. enter 100 which is equal to 1.00)');
