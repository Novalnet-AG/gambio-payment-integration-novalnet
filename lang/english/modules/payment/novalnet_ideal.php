...
define('MODULE_PAYMENT_NOVALNET_IDEAL_TEXT_DESCRIPTION', 'The payment will be processed in the test mode therefore amount for this transaction will not be charged');
define('MODULE_PAYMENT_NOVALNET_IDEAL_STATUS_TITLE', 'Enable payment method');
define('MODULE_PAYMENT_NOVALNET_IDEAL_STATUS_DESC', 'Do you want to accept ideal payment?');
...
define('MODULE_PAYMENT_NOVALNET_IDEAL_ORDER_STATUS_DESC', 'Status to be used for successful orders');
...
define('MODULE_PAYMENT_NOVALNET_IDEAL_VISIBILITY_BY_AMOUNT_TITLE', 'Minimum order amount.');
define('MODULE_PAYMENT_NOVALNET_IDEAL_VISIBILITY_BY_AMOUNT_DESC', 'Minimum order amount to display the selected payment method (s) at during checkout (in minimum unit of currency. E.g. enter 100 which is equal to 1.00)');
...
define('MODULE_PAYMENT_NOVALNET_IDEAL_TEXT_INFO', 'You will be redirected to iDEAL | Wero. Please don’t close or refresh the browser until the payment is completed');
