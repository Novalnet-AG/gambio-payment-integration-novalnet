...
define('MODULE_PAYMENT_NOVALNET_TWINT_TEXT_INFO', 'You will be redirected to TWINT. Please don’t close or refresh the browser until the payment is completed.');
