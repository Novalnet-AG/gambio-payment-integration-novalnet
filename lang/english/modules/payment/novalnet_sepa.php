...
define('MODULE_PAYMENT_NOVALNET_SEPA_DUE_DATE_DESC', 'Number of days after which the payment is debited (must be between 3 and 14 days)');
...
define('MODULE_PAYMENT_NOVALNET_SEPA_TEXT_INFO', 'The amount will be debited from your account by Novalnet');
