...
define('MODULE_PAYMENT_NOVALNET_DIRECT_DEBIT_ACH_AUTHENTICATE_TITLE', 'Payment action');
define('MODULE_PAYMENT_NOVALNET_DIRECT_DEBIT_ACH_AUTHENTICATE_DESC', 'Choose whether or not the payment should be charged immediately. Authorize verifies payment details and reserves funds to capture it later, giving time for the merchant to decide on the order.</br></br>Authorize with zero amount');
...
define('MODULE_PAYMENT_NOVALNET_DIRECT_DEBIT_ACH_NEW_ACCOUNT_DETAILS', 'Add new account details');
