...
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_AUTHENTICATE_DESC', 'Choose whether or not the payment should be charged immediately.');
...
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_BUTTON_DISPLAY_TITLE', 'Display the Apple Pay Button on <br>');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_BUTTON_DISPLAY_DESC', 'The selected pages will display the Apple pay button to pay instantly as an express checkout button <br><br>');
...
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_DISPLAY_CARTPAGE', 'Shopping cart page');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_DISPLAY_PRODUCTPAGE', 'Product page');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_DISPLAY_CHECKOUTPAGE', 'Checkout page');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_PLAIN', 'Plain');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_BUY', 'Buy');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_DONATE', 'Donate');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_BOOK', 'Book');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_CHECKOUT', 'Checkout');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_ORDER', 'Order');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_SUBSCRIBE', 'Subscribe');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_PAY', 'Pay');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_CONTRIBUTE', 'Contribute');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_TIP', 'Tip');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_RENT', 'Rent');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_RELOAD', 'Reload');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_SUPPORT', 'Support');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_DARK', 'Dark');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_LIGHT', 'Light');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_LIGHT_OUTLINE', 'Light-Outline');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_ESTIMATEDTOTAL_LABEL', 'Estimated total (No offers applied)');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_TOTAL_LABEL', 'Total');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_INCL_TAX_LABEL', 'Incl Tax');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_EXCL_TAX_LABEL', 'Excl Tax');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_DISCOUNT_AND_GIFT_VOUCHER_LABEL', 'Discount');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_SHIPPING_LABEL', 'Shipping');
define('MODULE_PAYMENT_NOVALNET_APPLEPAY_BUTTON_PAGES_TEXT', 'Button display pages');
